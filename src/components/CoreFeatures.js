  ...
  return (
    <section className="container mx-auto px-4 md:px-16 flex flex-col lg:flex-row items-center lg:gap-20 gap-14">
      <div className="flex flex-col gap-2 flex-1">
        <span className="text-amber-800 uppercase block font-semibold tracking-widest">
       ...
       Need Help?
        ...
        We’re here to answer your questions and provide you with a detailed quote for your next project.
        </p>
        <Link href="/contact">
        <button className="mt-5 w-fit md:text-base text-sm hover:border-2 border-2 border-transparent font-semibold py-3 px-8 md:px-10 text-white bg-amber-800 hover:border-amber-800 hover:bg-amber-800 hover:shadow-amber-800 hover:shadow-2xl rounded-full">
          Contact Us
        </button>
        </Link>
